...
const META_KEY_CODE_RE = new RegExp('^(?:\\x1b)([a-zA-Z0-9])$')
...
const CSI_U_RE = new RegExp('^\\x1b\\[(\\d+)(?:;(\\d+))?u')
...
const CURSOR_POSITION_RE = new RegExp('^\\x1b\\[\\?(\\d+);(\\d+)R$')
...
const XTVERSION_RE = new RegExp('^\\x1bP>\\|(.*?)(?:\\x07|\\x1b\\\\)$', 's')
